# Django settings for ocpcatmaid project.
...
ROOT_URLCONF = 'ocpcatmaid.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ocpcatmaid.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'logfile': {
            ...
            'filename': "/var/log/ocpcatmaid" + "/ocpcatmaid.log",
